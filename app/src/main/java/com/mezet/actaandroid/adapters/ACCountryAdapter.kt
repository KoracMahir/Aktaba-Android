...
class ACCountryAdapter(val autocompleteCountry: AutocompleteCountry, val context : Context) :
    RecyclerView.Adapter<ACCountryAdapter.ViewHolder>() {
    ...
    override fun getItemCount(): Int {
        Log.d("country1",autocompleteCountry.size.toString())
        return autocompleteCountry.size
    }

    var nposition=0
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.text1.text = autocompleteCountry[position].TerritoryName
        val npos= nposition
        ...
        Log.d("country1",autocompleteCountry[position].TerritoryName)
    }
    fun onPosition():Int{
        return nposition
    }
