...
import com.mezet.actaandroid.presenters.investicije.PrivatizacijaPresenter
import com.mezet.actaandroid.presenters.vijesti.BiHPresenter
import com.mezet.actaandroid.views.VijestiView


class PrivatizacijaFragment : Fragment(),VijestiView {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_privatizacija, container, false)
        PrivatizacijaPresenter(this).getVijestiFromAPI()
