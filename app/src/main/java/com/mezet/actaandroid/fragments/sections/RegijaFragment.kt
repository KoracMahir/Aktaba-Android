...
class RegijaFragment : Fragment(),VijestiView {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_regija, container, false)
        RegijaPresenter(this).getVijestiFromAPI()
