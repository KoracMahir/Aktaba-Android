...
import com.mezet.actaandroid.presenters.investicije.NekretninePresenter
import com.mezet.actaandroid.presenters.vijesti.BiHPresenter
import com.mezet.actaandroid.views.VijestiView

class NekretnineFragment : Fragment(),VijestiView {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_nekretnine, container, false)
        NekretninePresenter(this).getVijestiFromAPI()
