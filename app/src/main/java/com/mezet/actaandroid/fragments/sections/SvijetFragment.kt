...
import com.mezet.actaandroid.presenters.vijesti.RegijaPresenter
import com.mezet.actaandroid.presenters.vijesti.SvijetPresenter
import com.mezet.actaandroid.views.VijestiView

class SvijetFragment : Fragment(),VijestiView {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_svijet, container, false)
        SvijetPresenter(this).getVijestiFromAPI()
