...
import com.mezet.actaandroid.presenters.investicije.ImovinaUStecajuPresenter
import com.mezet.actaandroid.presenters.vijesti.BiHPresenter
import com.mezet.actaandroid.views.VijestiView


class ImovinaUStrecajuFragment : Fragment(),VijestiView {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_imovina_u_strecaju, container, false)
        ImovinaUStecajuPresenter(this).getVijestiFromAPI()
