...
import com.mezet.actaandroid.presenters.investicije.ProjektiPresenter
import com.mezet.actaandroid.presenters.vijesti.BiHPresenter
import com.mezet.actaandroid.views.VijestiView


class ProjektiFragment : Fragment(),VijestiView{
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_projekti, container, false)
        ProjektiPresenter(this).getVijestiFromAPI()
