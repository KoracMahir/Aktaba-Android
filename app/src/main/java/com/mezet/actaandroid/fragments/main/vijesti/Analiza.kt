...
class Analiza : Fragment(), MostRecentNewsView {
    ...
    override fun onCreateView(
        ...
        val view : View = inflater.inflate(R.layout.fragment_analiza, container, false)
        ...
        analiza_choosed.visibility=View.VISIBLE

        vijesit_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_vijesti)
            drawer.closeDrawer(Gravity.LEFT)
        })
        investicije_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_investicije)
            drawer.closeDrawer(Gravity.LEFT)
        })
        kapital_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_kapital)
            drawer.closeDrawer(Gravity.LEFT)
        })
        eu_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_EU)
            drawer.closeDrawer(Gravity.LEFT)
        })
        najave_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_najaves)
            drawer.closeDrawer(Gravity.LEFT)
        })
        licnosti_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_licnosti)
            drawer.closeDrawer(Gravity.LEFT)
        })
        karijera_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_karijera)
            drawer.closeDrawer(Gravity.LEFT)
        })
        kolumna_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_kolumna)
            drawer.closeDrawer(Gravity.LEFT)
        })
        pauza_drawer.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_pauza)
            drawer.closeDrawer(Gravity.LEFT)
        })
        ...
        home.setOnClickListener(View.OnClickListener {
            findNavController().navigate(R.id.action_analiza_to_homeFragment)
        })
