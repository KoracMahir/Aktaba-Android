...
import com.mezet.actaandroid.fragments.main.mojRegistar.rezultati.PressClippingFragment
...
class OsnovniPodaciPressPresenter(context: PressClippingFragment) {
    val profilkompanijeview = context as CompanyByIdView

    fun getClientCompanyPress(companyid:Int,token:String) {
