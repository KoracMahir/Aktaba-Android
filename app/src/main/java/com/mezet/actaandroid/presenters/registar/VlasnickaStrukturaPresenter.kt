...
import com.mezet.actaandroid.fragments.main.mojProfil.FirmaHeaderFragment
import com.mezet.actaandroid.fragments.main.mojRegistar.sections.VlasnickaStrukturaFragment
...
class VlasnickaStrukturaPresenter(context: VlasnickaStrukturaFragment) {
    val profilkompanijeview = context as CompanyByIdView

    fun getClientCompanyVl(companyid:Int,token:String) {
