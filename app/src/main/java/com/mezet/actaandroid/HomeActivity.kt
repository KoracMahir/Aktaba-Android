...
class HomeActivity : AppCompatActivity() {
    ...
    private fun createItems() {
        addItem("HOME", arrayOf("Konvertor valuta", "Berza", "Kursna lista", "Kreditni kalkulator"), R.color.home)
        addItem("VIJESTI", arrayOf("Vijesti", "Investiciji", "Kapital", "EU","Najave","Ličnosti","Karijera","Kolumna","Pauza","Analize"), R.color.vijesti)
        addItem("REGISTAR", arrayOf("Kompanije i institucije"), R.color.registar)
        addItem("TENDERI", arrayOf("Dodjela ugovora","Objavi tender","Legistlativa"), R.color.tenderi)
        addItem("PROMO", arrayOf("Kategorije oglasa","Objavi oglas"), R.color.promo)
        addItem("MOJ PROFIL", arrayOf("Porfil korisnika","Profil kompanije","Newsletter","Praćenje kompanija","Izdvojeno","Pošalji upit"), R.color.profile)
        addItem("O AKTI", arrayOf("Nagrade i priznanja","Izvještaj o radu","Kontakti"), R.color.promo)
